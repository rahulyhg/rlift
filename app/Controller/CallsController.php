...
class CallsController extends AppController {
	...
	var $uses = array('User','VehicleName','Country','State','City','Price','AirportPrice','PromoCode','Driver','InfoVehicle','Customer','AssignVehicleToDriver','IntercityFindCabOrders','PickupPoint','LaterRide');
