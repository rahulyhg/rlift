	    ...
	    // call for resend otp
	     ...
	     Configure::write('debug',0);
			 ...
			 if(!empty($_POST)){ 
				...
				$otp = file_get_contents('http://sms.ssdindia.com/api/sendhttp.php?authkey=10559Ay4ScEtjn567289c0&mobiles='.$phone_no.'&message=Dear '.$name.', your verification code is '.$otp.'. Team RiteLift&sender=kiv.phy&route=1');
				$status = '[{"status":"success"}]';
				echo $status;
	            die();
	      }
