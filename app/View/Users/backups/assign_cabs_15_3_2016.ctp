...
<!--PAGE CONTENT -->
		...
		<div class="row">
									    <div class="col-lg-12">
										<h3 class="page-header">ASSIGN CABS</h3>
									   </div>
	   </div>
  ...
  <div class="col-lg-2" style="text-align: center;">
                          ...
                          <a class="quick-btn hvr-float-shadow" href="#" style="width: 115px;height: 97px;border-radius: 25px;">
  ...
  <div class="col-lg-2" style="text-align: center;">
                           <a class="quick-btn hvr-float-shadow" href="#" style="width: 115px;height: 97px; border-radius: 25px;">
                                <i style="font-size: 36px;padding-bottom: 4px;" class="fa fa-odnoklassniki-square"></i> 
  ...
  <div class="col-sm-5 col-md-6">
    ...
    <ul style="max-height: 400px;overflow-y: auto;margin-left: -40px;">
   ...
   <img style="margin-left: 12px; border-radius: 50px; margin-top: 12px; width: 44px;float:left; height: 44px;"  src="<?php $driver_photo; ?>" />
   <div style="padding-top: 25px;
    ...
    font-weight: 500; float:left; width: 174px;"> <?php echo $value['Driver']['fname'].' '.$value['Driver']['lname']; ?></div>
	 ...
	 <div style="padding-top: 25px;
    padding-left: 11px;
    font-weight: bold; float:left; <?php if($isallocated == 'allocated') { echo 'color: green;'; }   ?>"><?php echo $isallocated; ?></div>
	...
	<?php
		foreach($cabs as $key=>$value)
		{
		   ...
		   $cab_photo = $this->webroot.'files/cab/'.$driver_photo;
   ...
   <img style="margin-left: 12px; border-radius: 50px; margin-top: 12px; width: 44px;float:left; height: 44px;"  src="<?php echo $cab_photo; ?>" />
 ...
 <div class="row">
  ...
  <div class="col-sm-4 col-md-5">
   <a href="#" class="btn btn-info" role="button" id="allhit"> <i class="fa fa-odnoklassniki-square" style="font-size: 16px;padding-right: 5px;"></i> ALLOCATE</a>
    <a href="#" class="btn btn-warning" role="button" id="unallhit"> <i class="fa fa-odnoklassniki-square" style="font-size: 16px;padding-right: 5px;"></i> UNALLOCATE</a>
...
$('#cab-criteria').keyup(function(){
 ...
 if ($('.drivers').is(':checked') == true) {
            ...
            alert('please choose driver to unallocate cab !!');
			return false;
          }
