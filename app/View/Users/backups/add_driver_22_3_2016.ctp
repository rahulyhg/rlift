         ...
         margin-left: -20px;">
            ...
            <?php echo $this->Form->create('Users', array('type' => 'file','data-parsley-validate')); ?>
             ...
             <div style="width: 42%;float: left;">
					...
					<div style="margin-bottom: 10px;"> Driver have a vehicle</div>
					<div style="clear:both;"></div>
					
					<div style="float:left;">
					<input type="radio" id="radio1" name="have_vehicle" class="have_vehicle" value="yes"  
					style="cursor: pointer;" />
					<label for="radio1">Yes</label>
					</div>

					<div style="padding-left: 62px;">
					<input type="radio"  name="have_vehicle" class="have_vehicle" id="radio2"  checked value="no" style="cursor: pointer;" />
					<label for="radio2">No</label>
					</div>
							...
							<div class="section vehno" style="display:none;">
                    	    
							 <label class="field prepend-icon">
                        	<input id="veh_no" name="veh_no" class="gui-input" placeholder="Enter vehicle number" type="text" list="browsers" >
                            <b class="tooltip tip-right"><em> please enter vehicle number</em></b>
