        ...
        <div id="top">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
			   ...
			   ">rLIFT</p>
				...
				<a href="<?php echo $this->webroot; ?>logout" style=" color: white;float: right;padding-right: 30px;font-family: cursive;"><i class="icon-signout"></i> Logout </a>
               ...
               ADMIN SETTINGS SECTIONS 
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="<?php echo $this->webroot; ?>logout"><i class="icon-signout"></i> Logout </a>
                            </li>
                        </ul>
